...
@section('content')
  ...
  <div class="sm:flex sm:items-center">
      <div class="sm:flex-auto">
        <p class="mt-2 text-sm text-gray-700">A list of all stores.</p>
      </div>
          ...
          <table class="min-w-full divide-y divide-gray-300" id="filterTable">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                @foreach ( $term_query ->terms as $term )
                  ...
                  @include('partials.content-store')
            ...
            <div class="p-12 text-center">
              ...
              <p class="mt-1 text-sm text-gray-500">Get started by adding a store and then adding contacts.</p>
              <div class="mt-6">
                @include('components.modal-new-store')
              </div>
            </div>
