  ...
  <div class="border-t border-gray-200">
    <dl>
      ...
      <div class="px-4 py-5 bg-gray-50 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
        ...
        <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">{{ $s_phone->national }}</dd>
      </div>
      <div class="px-4 py-5 bg-white sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
...
<div class="flex-1 overflow-hidden bg-white shadow sm:rounded-lg">
  ...
  <div class="border-t border-gray-200">
    <dl>
      ...
      <div class="px-4 py-5 bg-gray-50 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
        <dt class="text-sm font-medium text-gray-500">Phone</dt>
        <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">{{ $b_phone->national }}</dd>
      </div>
      <div class="px-4 py-5 bg-white sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
        <dt class="text-sm font-medium text-gray-500">Fax</dt>
