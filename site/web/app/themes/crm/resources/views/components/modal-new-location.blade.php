<div x-data="{ open: false }" class="z-[9999999999999] flex justify-center" id="formmodal editreconcenter">
        ...
        >
            ...
            >
                <div class="flex" id="header">
                  <div class="flex-1">
                    <h2 class="text-3xl font-bold" :id="$id('modal-title')">Add Location</h2>
                  </div>
                  <div>
