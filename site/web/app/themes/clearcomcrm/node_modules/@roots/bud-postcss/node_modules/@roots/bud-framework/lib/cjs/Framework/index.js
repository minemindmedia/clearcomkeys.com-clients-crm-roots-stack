...
const { isFunction, omit } = bud_support_1.lodash;
/**
...
class Framework {
    ...
    constructor(options) {
         ...
         * @public
         */
        this.json = bud_support_1.parsers.json5;
        /**
         * Read and write yaml files
         *
         * @public
         */
        this.yml = bud_support_1.parsers.yml;
        /**
         * timer util
         *
         * @public
    ...
    debug(...messages) {
        ...
        this.context.stdout.write(`${(0, bud_support_1.highlight)((0, bud_support_1.format)(messages, {
            callToJSON: false,
            maxDepth: 8,
    ...
    dump(obj, options) {
        ...
        // eslint-disable-next-line no-console
        process.stdout.write(`${options?.prefix ? `\n${options.prefix}\n` : `\n`}${(0, bud_support_1.highlight)((0, bud_support_1.format)(obj, {
            callToJSON: false,
            maxDepth: 8,
            printFunctionName: false,
            escapeString: false,
