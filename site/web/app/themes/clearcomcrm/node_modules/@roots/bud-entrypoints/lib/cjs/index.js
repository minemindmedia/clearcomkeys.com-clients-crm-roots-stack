...
const debounceFn = __nccwpck_require2_(491);
...
const throttleFn = __nccwpck_require2_(38);
...
const onceFn = __nccwpck_require2_(499);
...
const memoizeFn = __nccwpck_require2_(538);
...
const helpful_decorators_1 = __nccwpck_require2_(349);
const webpack_1 = __nccwpck_require2_(846);
/**
...
const autobind_decorator_1 = __nccwpck_require2_(542);
const lodash_1 = __nccwpck_require2_(250);
const webpack_1 = __nccwpck_require2_(846);
const inline_emitter_1 = __nccwpck_require2_(373);
/**
 ...
 */
var webpack_plugin_1 = __nccwpck_require2_(519);
Object.defineProperty(exports, "EntrypointsWebpackPlugin", ({ enumerable: true, get: function () { return webpack_plugin_1.EntrypointsWebpackPlugin; } }));
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.BudEntrypointsExtension = void 0;
const entrypoints_webpack_plugin_1 = __nccwpck_require__(670);
/**
 * BudEntrypointsExtension
 *
 * @public
 */
exports.BudEntrypointsExtension = {
    name: '@roots/bud-entrypoints',
    options: () => ({
        emitHtml: false,
    }),
    make: options => {
        return new entrypoints_webpack_plugin_1.EntrypointsWebpackPlugin(options.all());
    },
};
...
// Licensed under the MIT license.
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.make = exports.options = exports.name = void 0;
/**
 ...
 * @packageDocumentation
 */
const entrypoints_extension_1 = __nccwpck_require__(826);
exports.name = entrypoints_extension_1.BudEntrypointsExtension.name, exports.options = entrypoints_extension_1.BudEntrypointsExtension.options, exports.make = entrypoints_extension_1.BudEntrypointsExtension.make;
