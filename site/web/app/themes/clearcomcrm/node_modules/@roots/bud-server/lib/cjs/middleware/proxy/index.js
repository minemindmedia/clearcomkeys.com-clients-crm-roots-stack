...
const proxy = (app) => {
    ...
    const options = {
         ...
         * Follow redirects
         */
        followRedirects: app.hooks.filter(`middleware.proxy.options.followRedirects`, false),
        /**
         * Headers
         */
        headers: {
         ...
         * Protocol rewrite
         */
        protocolRewrite: app.hooks.filter(`middleware.proxy.options.protocolRewrite`, url.dev.protocol?.startsWith('https') ? 'https' : undefined),
        /**
         * Secure
         */
