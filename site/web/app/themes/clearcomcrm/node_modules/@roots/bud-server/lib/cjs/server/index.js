...
class Server extends Framework.Service {
    ...
    async boot() {
        ...
        this.app.hooks.action('event.server.after', async () => this.watcher.watch());
    }
    /**
     * Set connection
     *
    ...
    async setConnection() {
        this.connection =
            this.app.hooks.filter('dev.options') &&
                ...
                ? new server_https_1.Https(this.app, this.app.hooks.filter('dev.url'))
                : new server_http_1.Http(this.app, this.app.hooks.filter('dev.url'));
