...
export interface Hooks extends Service {
     ...
     * @public
     */
    on<T extends keyof Hooks.Map & string>(id: T, callback?: ((param?: Hooks.Map[T]) => Hooks.Map[T]) | Hooks.Map[T]): Framework;
    /**
     ...
     * @public
     */
    async<T extends keyof Hooks.AsyncMap & string>(id: T, callback?: (param?: Hooks.AsyncMap[T]) => Promise<Hooks.AsyncMap[T]>): Framework;
    /**
     * Filter a value
     *
     * @example
     ...
     * @public
     */
    filterAsync<T extends keyof Hooks.AsyncMap & string>(id: T, value?: Hooks.AsyncMap[T] | ((param?: Hooks.AsyncMap[T]) => Promise<Hooks.AsyncMap[T]>)): Promise<Hooks.AsyncMap[T]>;
    /**
     * Event
     *
     * @public
     ...
     * @public
     */
    action<T extends keyof Hooks.Events & string>(id: T, ...action: Array<(app: Framework) => Promise<unknown>>): Framework;
}
/**
 * @public
 */
export declare namespace Hooks {
    ...
    type EventMap = {
        [K in Keys['events'] as `${K & string}`]: (app: Framework) => Promise<any>;
    };
     ...
     * @public
     */
    export interface Map extends Server.Middleware.Middleware<`options`>, Server.Middleware.Middleware<`factory`>, Server.Connection.OptionsMap, LocationKeyMap, ConfigMap {
        ...
        [key: `extension.${(keyof Modules & string) | (keyof Plugins & string)}`]: any;
        [key: `extension.${(keyof Modules & string) | (keyof Plugins & string)}.options`]: Container<Record<string, any>>;
    }
    export {};
}
