 ...
 * @public
 */
export interface ReactRefreshExtension extends Bud.Extension.CompilerPlugin<RefreshPlugin, ReactRefreshPluginOptions> {
...
export declare const ReactRefreshExtension: ReactRefreshExtension;
