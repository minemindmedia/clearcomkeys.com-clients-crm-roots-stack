...
const infrastructureLogger = {
    count: {},
    instance: new bud_support_1.Signale({ scope: `webpack` }),
};
/**
...
exports.seed = {
    ...
    [`build.infrastructureLogging.console`]: app => ({
        ...
        count: (label) => {
            ...
            infrastructureLogger.instance.info(`${label}: ${infrastructureLogger.count[label]}`);
        },
        countReset: (label) => {
        ...
        table: (tabularData, properties) => infrastructureLogger.instance.log(bud_support_1.table.table(tabularData)),
        time: infrastructureLogger.instance.time,
        timeEnd: infrastructureLogger.instance.timeEnd,
        timeLog: () => null,
        trace: (message, ...params) => infrastructureLogger.instance.log(`Trace: `, message ? (0, bud_support_1.prettyFormat)(message) : ``, ...params),
    ...
    [`build.parallelism`]: app => Math.max((0, os_1.cpus)().length - 1, 1),
    [`build.performance`]: app => ({ hints: false }),
    [`build.resolve.alias`]: app => ({
        '@src': app.path('@src'),
        '@dist': app.path('@dist'),
    }),
    [`build.resolve.extensions`]: app => new Set([
        `.wasm`,
        `.mjs`,
        `.js`,
        `.jsx`,
