<div x-data="{ open: false }" class="flex justify-center" id="editdealership">
    ...
    >
        ...
        >
            ...
            >
                <div class="flex">
                  <div class="flex-1">
                    <h2 class="text-3xl font-bold" :id="$id('modal-title')">Add Dealership</h2>
                  </div>
                  <div>
                ...
                <?php acf_form(array(
                    ...
                    'return' => '%post_url%',
                    'submit_value'  => 'Add new dealership'
                )); ?>
