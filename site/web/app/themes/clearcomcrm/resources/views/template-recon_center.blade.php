...
@section('content')
  ...
  @php
      $term_query = new WP_Term_Query( array( 
          'taxonomy' => 'recon-center', // <-- Custom Taxonomy name..
          'orderby'                => 'name',
          'order'                  => 'ASC',
          'child_of'               => 0,
          'parent' => 0,
  ...
  <div class="sm:flex sm:items-center">
    <div class="sm:flex-auto">
      <h1 class="text-xl font-semibold text-gray-900">Recon Centers</h1>
    ...
    <div class="mt-4 sm:mt-0 sm:ml-16 sm:flex-none">
      @include('components.modal-new-recon_center')
    </div>
  </div>
        ...
        <div class="overflow-hidden shadow ring-1 ring-black ring-opacity-5 md:rounded-lg">
          <table class="min-w-full divide-y divide-gray-300">
            <thead class="bg-gray-50">
              <tr>
                <th scope="col" class="py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-gray-900 sm:pl-6">Recon Center Name</th>
            ...
            <tbody class="bg-white divide-y divide-gray-200">
              ...
              @if ( ! empty( $term_query->terms ) )
                ...
                @foreach ( $term_query ->terms as $term )
                  ...
                  @include('partials.content-recon_center')
                  
                @endforeach

                @else
                
                <p>No recon centers found</p>/
